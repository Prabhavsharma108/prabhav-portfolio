...
const DOOR_AUDIO_SETTINGS = {
    hoverVolume: 0.8, // Volume for "door-hover" (hovering the door)
    openVolume: 0.2,  // Volume for "door-open" (opening the door fully)
