...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'PRABHAV', subtitle: '< full stack & AI engineer />' },
    ...
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'React • Next.js • Node.js • LangGraph' },
];
