            ...
            >
                <div
                    style={{
                        ...
                        ...cardStyle,
                        // Override styles for grid layout and work experience to be centered and wider
                        ...((content.layout === 'certificate_grid' || content.layout === 'work_experience') ? {
                ...
                >
                    ...
                    {content.layout === 'work_experience' ? (
                        <div style={{ position: 'relative', flex: 1, minHeight: 0 }}>
                            <div
                                ...
                                style={{
                                    ...
                                    padding: isMobile ? '1rem 0.8rem 2rem 0.8rem' : '1rem 2rem 2rem 1rem',
                                }}>
                                {/* Company Header */}
                                <div style={{
                                    backgroundColor: content.platformConfig?.color || '#4285F4',
                                    color: 'white',
                                    padding: isMobile ? '1.2rem 1rem' : '1.8rem 1.5rem',
                                    ...
                                    <div style={{
                                        ...
                                        {content.platformConfig?.icon} {content.title}
                                    </div>
                                    <div style={{
                                        ...
                                        <ul style={{
                                            ...
                                            {content.highlights.map((highlight, idx) => (
                                                <li key={idx} style={{
                                                    ...
                                                    backgroundColor: '#fff',
                                                    border: '2px solid #1a1a1a',
                                                    borderLeft: `5px solid ${content.platformConfig?.color || '#4285F4'}`,
                                                    borderRadius: '2px 255px 3px 255px / 255px 5px 225px 3px',
                                ...
                                {content.items && content.items.length > 0 && (
                                    <div style={{ ...getStaggerStyle(250) }}>
                                        ...
                                        <div style={{
                                            display: 'grid',
                                            gridTemplateColumns: isMobile ? '1fr' : (content.items.length === 1 ? '1fr' : 'repeat(auto-fit, minmax(280px, 1fr))'),
                                ...
                                {content.detailsFile && (
                                    <div style={{
                                        ...
                                        <button
                                            onClick={() => window.open(content.detailsFile, '_blank')}
                                            style={{
